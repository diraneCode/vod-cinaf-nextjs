...
const ModalDetail = ({ closeModal })  => {
  return (
    <>
      <div className="fixed inset-0 bg-black/80"></div>
      <div className='w-3/5 h-screen overflow-y-scroll scrollbar-none z-40 bg-[#262626] text-white space-y-4 fixed top-2 left-1/2 -translate-x-1/2'>
        <div className="w-full h-3/5 bg-[#262626]/40 relative rounded-md overflow-hidden">
          ...
          <Image src='/ressources/home.png' alt='cover' width={1000} height={100}
